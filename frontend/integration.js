(function () {
    ...
    window.VanidayApi = {
        ...
        toLegacyBooking:function(b){ return { _id:b._id, customerId:b.customerId || (b.customer && b.customer._id), customer:b.customerName || (b.customer && b.customer.fullName) || b.customer || 'Guest', customerEmail:b.customerEmail || (b.customer && b.customer.email) || '', merchant:(b.merchant && b.merchant.name) || b.merchant, service:(b.service && b.service.name) || b.service, date:b.bookingDate || b.date, time:b.bookingTime || b.time, amount:b.amount, reward:b.reward, loyaltyAwarded:b.loyaltyAwarded, bookingSource:b.bookingSource || 'Website', status:b.status }; }
    };
